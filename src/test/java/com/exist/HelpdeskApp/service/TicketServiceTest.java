...
public class TicketServiceTest {
    ...
    void testGetValidTickets() {
        ...
        List<TicketResponse> result = ticketService.getTickets(VALID_EMPLOYEE_ID);
    ...
    void testGetValidTicketsButEmployeeNotFound() {
        ...
        assertThrows(EmployeeNotFoundException.class, () -> ticketService.getTickets(INVALID_EMPLOYEE_ID));
    }
    ...
    void testGetValidTicket() {
        ...
        TicketResponse result = ticketService.getTicket(VALID_EMPLOYEE_ID, ticket1.getTicketNumber());
    ...
    void testGetValidTicketButTicketNotFound() {
        ...
        assertThrows(TicketNotFoundException.class, () -> ticketService.getTicket(VALID_EMPLOYEE_ID, 99));
    }
    ...
    void testFileValidTicket() {
        ...
        TicketResponse result = ticketService.fileTicket(VALID_EMPLOYEE_ID, ticketRequest);
    ...
    void testFileTicketButEmployeeNotFound() {
        Mockito.when(employeeRepository.findById(INVALID_EMPLOYEE_ID)).thenReturn(Optional.empty());
        assertThrows(EmployeeNotFoundException.class, () -> ticketService.fileTicket(INVALID_EMPLOYEE_ID, ticketRequest1));
    }
    ...
    void testUpdateValidTicketAssignedToEmployee() {
        ...
        TicketResponse result = ticketService.updateTicket(VALID_EMPLOYEE_ID, 1, ticketRequest);
    ...
    void testUnauthorizedAttemptToAlterTicketsThatAreNotAssigned() {
        ...
        assertThrows(UnauthorizedActionException.class, () -> ticketService.updateTicket(VALID_EMPLOYEE_ID, 2, ticketRequest));
    }
    ...
    void testUnauthorizedAttemptToUpdateAssignedEmployee() {
        ...
        Mockito.when(employeeRepository.findById(VALID_EMPLOYEE_ID)).thenReturn(Optional.of(employee1));
        Mockito.when(ticketRepository.findById(1)).thenReturn(Optional.of(ticket1));
        assertThrows(UnauthorizedActionException.class, () -> ticketService.updateTicket(VALID_EMPLOYEE_ID, 1, ticketRequest));
    }
    ...
    void testAdminUpdateAssignedEmployee() {
        ...
        TicketResponse result = ticketService.updateTicket(ADMIN_EMPLOYEE_ID, 2, ticketRequest);
    ...
    void testAdminUpdateAssignedEmployeeButEmployeeNotFound() {
        ...
        assertThrows(EmployeeNotFoundException.class, () -> ticketService.updateTicket(ADMIN_EMPLOYEE_ID, 2, ticketRequest));
    }
    ...
    void testGetAssignedTickets() {
        ...
        List<TicketResponse> result = ticketService.getAssignedTickets(VALID_EMPLOYEE_ID);
        assertEquals(1, result.size());
    }
    ...
    void testGetAssignedTicketsButEmployeeNotFound() {
        Mockito.when(employeeRepository.findById(INVALID_EMPLOYEE_ID)).thenReturn(Optional.empty());
        assertThrows(EmployeeNotFoundException.class, () -> ticketService.getAssignedTickets(INVALID_EMPLOYEE_ID));
    }
}
